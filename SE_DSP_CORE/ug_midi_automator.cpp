...
namespace
{
REGISTER_MODULE_1_BC(90,L"MIDI Automator", IDS_MN_MIDI_AUTOMATOR,IDS_MG_DEBUG,ug_midi_automator ,CF_DONT_EXPAND_CONTAINER|/*CF_CONTROL_AUTOMATOR|*/CF_STRUCTURE_VIEW,L"Enables MIDI automation of all a container's controls. See <a href=midi_control.htm>Patches & MIDI Control</a> for more.");
REGISTER_MODULE_1_BC(91,L"MIDI Automator Output", IDS_MN_MIDI_AUTOMATOR_OUTPUT,IDS_MG_DEBUG,ug_patch_automator_out ,CF_HIDDEN,L"Hidden module, provides MIDI output for control panel automation.");
}
